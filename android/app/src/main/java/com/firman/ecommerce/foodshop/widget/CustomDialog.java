package com.firman.ecommerce.foodshop.widget;
...
import com.firman.ecommerce.foodshop.databinding.DialogDefaultBinding;
...
public class CustomDialog {
    ...
    public CustomDialog removePositiveButton() {
        positiveText = null;
        positiveListener = null;
        return instance;
    }

    public CustomDialog removeNegativeButton() {
        negativeText = null;
        negativeListener = null;
        return instance;
    }

    public CustomDialog removeNeutralButton() {
        neutralText = null;
        neutralListener = null;
        return instance;
    }

    public CustomDialog addDismissListener(@NonNull DialogInterface.OnDismissListener listener) {
        alertDialog.setOnDismissListener(listener);
        return instance;
    }

    public CustomDialog addCancelListener(@NonNull DialogInterface.OnCancelListener listener) {
        alertDialog.setOnCancelListener(listener);
        return instance;
    }

    public CustomDialog addShowListener(final DialogInterface.OnShowListener listener) {
        this.onShowListener = listener;
        return instance;
    }

    public CustomDialog addFlag(int flag) {
        this.flag = flag;
        return instance;
    }
